...
{
public:
	Environment(CVK::CubeMapTexture* enviromentMap, unsigned int irrMapSize);
...
private:
	void setUp(CVK::CubeMapTexture* enviromentMap, unsigned int irrMapSize);

	void createCubeMapTextureBuffer(unsigned int sizeX, unsigned int sizeY, CVK::CubeMapTexture** texture);
	...
	CVK::FBO* m_irradianceFBO;

	CVK::ShaderSet* m_irradianceShader = nullptr;

	GLuint m_irradianceViewID;
